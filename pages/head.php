<head>
    ...
    <meta name="keywords" content="portfolio, développement informatique, Cédric Mariya Constantine, Cédric Mariya Constantine Portfolio">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="robots" content="index,follow">
    <!-- Balises meta -->

    <!-- Balises link -->
    <link rel="shortcut icon" href="<?= URL_SITE ?>img/favicon.png"><!-- Favicon -->
    <link rel="stylesheet" href="css/root.css">
    <link rel="stylesheet" href="css/style.css?t=<?=microtime();?>">
