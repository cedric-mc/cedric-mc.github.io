<section id="about-me">
    ...
    <div class="row align-items-center">
        <div class="col-md-6">
            ...
            <p>Voici mon CV, il est à votre disposition :&nbsp; <a id="cv-btn" class="btn btn-danger heartbeat heartbeat-hover" href="doc/CV_CEDRIC_MARIYA_CONSTANTINE.pdf" target="_blank">Télécharger&nbsp;<i class="fas fa-download"></i></a></p>
            <p>
