    ...
    <div class="row align-items-center">
        <div class="col-md-6">
            ...
            <p>
                ...
                <a class="btn btn-danger heartbeat heartbeat-hover text-light" href="doc/CV_CEDRIC_MARIYA_CONSTANTINE.pdf" target="_blank">Télécharger&nbsp;<i class="fas fa-download"></i></a>
            </p>
            <p>
