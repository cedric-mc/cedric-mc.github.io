...
<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="#top-page">
            <img src="img/navbar/home.png" class="d-inline-block align-text-top" alt="icon home">&nbsp;Accueil
        </a>
            ...
            <ul class="navbar-nav custom-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#parcours">
                        <img src="img/navbar/histoire.png" class="d-inline-block align-text-top">&nbsp;Parcours
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link active dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="img/navbar/settings.png" class="d-inline-block align-text-top">&nbsp;Apparence
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <button type="button" class="dropdown-item" data-theme-toggle data-theme-value="light">
                                <img src="img/navbar/sun.png" class="d-inline-block align-text-top">&nbsp;Clair
                            </button>
                        </li>
                        <li>
                            <button type="button" class="dropdown-item" data-theme-toggle data-theme-value="dark">
                                <img src="img/navbar/moon.png" class="d-inline-block align-text-top">&nbsp;Sombre
                            </button>
                        </li>
                        <li>
                            <button type="button" class="dropdown-item" data-theme-toggle data-theme-value="auto">
                                <img src="img/navbar/auto.png" class="d-inline-block align-text-top">&nbsp;Auto
                            </button>
                        </li>
                    </ul>
                </li>
