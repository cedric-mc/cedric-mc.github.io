<section id="projects">
    ...
    <p>
        Dans cette section, vous trouverez les projets auxquels j'ai participé dans le cadre de mon parcours professionnel. Vous pourrez consulter le code source <span class="code-icon spinner"></span> et la documentation <span class="documentation-icon spinner"></span> de chaque projet.
    </p>
