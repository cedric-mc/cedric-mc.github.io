<section id="projects">
    ...
    <p>
        Vous pourrez consulter le code source ou le lien
        <span class="code-icon spinner"></span> et la documentation et/ou
        description <span class="documentation-icon spinner"></span> de chaque projet.
    </p>
    <div id="projects-pro">
        <h3 class="subtitle-section">Mes Projets Professionnels</h3>
        <p>
            Dans cette section, vous trouverez les projets auxquels j'ai participé dans le cadre de mon parcours professionnel.
        </p>
        <div class="projet-container" id="atlas-gendarmerie">
            <div class="project-item">
                <h3 class="title-project">Atlas historique de la Gendarmerie Nationale</h3>
                <h4 class="project-language">HTML, CSS, JS, PHP, SQL</h4>
                <div>
                    <p>
                        Description officielle : "Le projet Atlas historique de la Gendarmerie est un projet interactif et collaboratif, composé de contributeurs variés (chercheurs, gendarmes, érudits, etc.).
                        Le projet vise à rendre accessible en ligne l'identification géolocalisée, dans l'histoire de France, des entités (unités et gendarmes) ayant composée la Maréchaussée, sous l'Ancien Régime, puis la Gendarmerie Nationale (depuis 1791)."
                        <br>
                        Site :&ensp;<a class="code-icon spinner" href="https://atlas-gendarmerie.fr/" target="_blank"></a><br>
                        Description :&ensp;<a class="documentation-icon spinner" href="https://atlas-gendarmerie.fr/?p=le_projet" target="_blank"></a><br>
                    </p>
                </div>
                <div id="carouselAtlas-GN" class="carousel carousel-dark slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#carouselAtlas-GN" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" data-bs-target="#carouselAtlas-GN" data-bs-slide-to="1" aria-label="Slide 2"></button>
                        <button type="button" data-bs-target="#carouselAtlas-GN" data-bs-slide-to="2" aria-label="Slide 3"></button>
                        <button type="button" data-bs-target="#carouselAtlas-GN" data-bs-slide-to="3" aria-label="Slide 4"></button>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/projects/atlas-gn-1.png" class="d-block w-100" alt="Atlas GN 1">
                        </div>
                        <div class="carousel-item">
                            <img src="img/projects/atlas-gn-2.png" class="d-block w-100" alt="Atlas GN 2">
                        </div>
                        <div class="carousel-item">
                            <img src="img/projects/atlas-gn-3.png" class="d-block w-100" alt="Atlas GN 3">
                        </div>
                        <div class="carousel-item">
                            <img src="img/projects/atlas-gn-4.png" class="d-block w-100" alt="Atlas GN 4">
                        </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselAtlas-GN" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselAtlas-GN" data-bs-slide="next">
    ...
    <div id="projects-univ">
        <h3 class="subtitle-section">Mes Projets Universitaires</h3>
        <p>
            Dans cette section, vous trouverez les projets que j'ai réalisés dans le cadre de mes études universitaires.
        </p>
        <div class="projet-container" id="semonkey">
            <div class="project-item">
                <h3 class="title-project">Semonkey, Jeu en ligne à un ou plusieurs joueurs</h3>
                <h4 class="project-language">
                    HTML&ensp;<i class="fa-brands fa-html5 character"></i>,
                    CSS&ensp;<i class="fa-brands fa-css3-alt character"></i>,
                    PHP&ensp;<i class="fa-brands fa-php character"></i>,
                    SQL&ensp;<i class="fa-solid fa-database character"></i>,
                    JS&ensp;<i class="fa-brands fa-square-js character"></i>,
                    C&ensp;<i class="fa-solid fa-c character"></i>,
                    Java&ensp;<i class="fa-brands fa-java character"></i>,
                    TypeScript&ensp;,
                    React&ensp;<i class="fa-brands fa-react character"></i>,
                    Android&ensp;<i class="fa-brands fa-android character"></i></h4>
                <p>
