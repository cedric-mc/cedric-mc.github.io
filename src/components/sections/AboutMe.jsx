            ...
            <Row className="align-items-center">
                <Col md={6}>
                    ...
                    <p>
                        ...
                        <a href="https://www.linkedin.com/in/cédric-mariya-constantine-a3a52325a/" target="_blank" rel="noreferrer" className="social-link">
                            <FontAwesomeIcon icon={faLinkedin} className="spinner"/>{' '}LinkedIn
                        </a> et{' '}
                        <a href="https://github.com/cedric-mc/" target="_blank" rel="noreferrer" className="social-link">
