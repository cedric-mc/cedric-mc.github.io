...
export function Parcours({ theme }: { theme: string }) {
    return (
        <section id="parcours">
            <h2 className="title-section">Mon Parcours</h2> {/* TODO: Centrer les titres de niveau 2 */}
                            ...
                            <TabPane eventKey="#list-stage-but3">
                                <Row>
                                    ...
                                    <Col className="d-flex flex-column justify-content-center">
                                        ...
                                        <p className="fst-italic">
                                            <span className="fw-bold">Du 24 mars au 26 août 2025</span><br/>
                                            Sous-bureau des cabinets du ministère de l'intérieur<br/>
                                            Paris<br/>
                                            Développement php
                                        </p>
